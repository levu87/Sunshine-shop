...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
				...
				<div class="cart-button-checkout">
					...
					<a class="btn btn-next">
						<xsl:attribute name="onclick">
							...
							<xsl:text>/checkout-login</xsl:text>
	...
	<xsl:template match="CartItem">
		<tr>
			<td>
				<figure>
					...
					<figcaption>
						...
						<!-- <p><xsl:value-of select="Code" disable-output-escaping="yes"></xsl:value-of></p> -->
			...
			<td>
				<!-- <xsl:if test="DiscountPercentage !=''"><div class="old"><xsl:value-of select="OriginalPrice"></xsl:value-of></div></xsl:if> -->
				<div class="new">
					<xsl:value-of select="Price"></xsl:value-of>
				</div>
				<xsl:if test="DiscountPercentage !=''">
					<del class="sale" style="color: #727c85">
			...
			<td>
				<div class="quantity input-number">
					<span class="minus btn-spin">-</span>
					...
					<input type="text" maxlength="10" class="quantity-number qty-input"
